...
const DEFAULT_PRIVILEGES = [
  {
    ...
    title: 'Shopee ส่วนลด 100 บาท',
    source: 'shopee',
    type: 'discount_code',
    code: 'PAYDAY100',
    description: 'ใช้ได้กับร้านที่ร่วมรายการ ตลอดปี',
    ...
    actualSavedAmount: 0,
    usedAt: null,
    note: 'ใช้กับร้านที่ร่วมรายการเท่านั้น',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'priv_lineman_delivery40',
    title: 'LINE MAN ลดค่าส่ง 40 บาท',
    source: 'line',
    type: 'voucher',
    code: 'LM40',
    description: 'ลดค่าส่งอาหาร ช่วง 17:00-23:00',
    expiryDate: TOMORROW,
    quantity: 2,
    usedQuantity: 0,
    estimatedValue: 40,
  ...
  {
    id: 'priv_lazada_voucherl80',
    title: 'Lazada ส่วนลด 80 บาท',
    source: 'lazada',
    type: 'voucher',
    code: 'LAZ80',
    description: 'ใช้กับสินค้าทั่วไป ยอดการซื้อตั้งแต่ 699 บาท',
  ...
  },
  {
    ...
    title: 'Cafe Amazon ซื้อ 1 แถม 1',
    source: 'brand',
    type: 'free_item',
    code: '',
    description: 'ซื้อเมนูครึ่งราคา แถมเครื่องดื่มฟรี',
    expiryDate: TWO_DAYS_AGO,
    quantity: 1,
    usedQuantity: 1,
    estimatedValue: 65,
    actualSavedAmount: 70,
    usedAt: TWO_DAYS_AGO,
  ...
  {
    id: 'priv_ccb_cashback5',
    title: 'บัตรเครดิต ชำระโลกมติ ต้องจ่ายเงินคืน 5%',
    source: 'credit_card',
    type: 'cashback',
    code: 'AUTOMATIC',
    description: 'เงินคืน 5% ตั้งแต่ 5,000 บาท ขึ้นไป',
    expiryDate: `${THIS_MONTH}-30`,
    quantity: 1,
    usedQuantity: 0,
    estimatedValue: 250,
    actualSavedAmount: 0,
